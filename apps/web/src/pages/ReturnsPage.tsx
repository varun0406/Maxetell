  ...
  async function handleExportMonthly() {
    ...
    try {
      ...
      const salesData = syncOrders.map(o => ({
        ...
        "Size": o.size,
        "Grade": o.grade,
        "Client PO": o.client_po_no || "",
        "Sales Date": o.sales_date || "",
        "OR No": o.or_no || "",
        "Invoice No": o.invoice_no || "",
        "Invoice Total": o.invoice_total || "",
        "Paid Amount": o.paid_amount || "",
        "Order Kgs": o.order_kgs,
        "Order Pcs": o.order_pcs,
        "Length Nos": o.length_nos || "",
        "Bill Rate": o.order_bill_rate || "",
        "Avg Cost": o.line_avg_cost || "",
        "Weight Sold": o.weight_sold || "",
        "Sales Return": o.sales_return || "",
        "Remarks": o.remarks || "",
      ...
      const histDispatches = syncDispatches.map(d => ({
        ...
        "Packing Weight": d.packing_weight || "",
        "Pcs": d.dispatch_pcs,
