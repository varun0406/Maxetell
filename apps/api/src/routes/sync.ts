  ...
  app.get("/sync/export", async (req) => {
    ...
    const orders = db.prepare(`
      SELECT 
        ...
        o.or_no, o.sales_date, o.weight_sold, o.sales_return, o.avg_cost, o.bill_rate as order_bill_rate, o.invoice_no, o.invoice_total, o.paid_amount, o.remarks,
        oli.id as line_id, oli.item, oli.size, oli.grade, oli.length_nos, oli.order_kgs, oli.order_pcs, oli.bill_rate, oli.avg_cost as line_avg_cost,
    ...
    const purchases = db.prepare(`
      SELECT 
        pe.id as purchase_entry_id, pe.po_no, pe.client_po_no, pe.purchase_date, pe.weight as ordered_weight, pe.rate, pe.received_weight, pe.debit_note, pe.rec_note, pe.remarks,
        s.name as supplier_name,
        p.item, p.size, p.grade,
